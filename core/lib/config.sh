...
al_set_default AL_GOAL_FILE        "GOALS.md"
al_set_default AL_GOAL_CONTRACT    "$AL_AGENT_DIR/goal.json"
al_set_default AL_PLAN_CONTRACT    "$AL_AGENT_DIR/plan.json"
al_set_default AL_TASKLIST_CONTRACT "$AL_AGENT_DIR/tasklist.json"
al_set_default AL_GOAL_STATE       "$AL_AGENT_DIR/goal-state.json"
